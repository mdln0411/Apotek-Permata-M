...
export default function ValidasiResep() {
  ...
  const [actionType, setActionType] = useState<"valid" | "rejected" | null>(
    null,
  );
  ...
  const handleUpdateStatus = async () => {
    ...
    try {
      ...
      Alert.alert(
        "Sukses",
        `Resep berhasil di${actionType === "valid" ? "validasi" : "tolak"}`,
      );
      ...
      Alert.alert(
        "Gagal",
        error.response?.data?.message || "Gagal memperbarui status resep",
      );
    } finally {
      setSubmitting(false);
    }
                    ...
                    <View style={styles.actionRow}>
                      ...
                      >
                        <Ionicons
                          ...
                          color={THEME.white}
                        />
                        <Text style={styles.btnValidText}>
                          Validasi Sekarang
                        </Text>
                      </TouchableOpacity>
                    </View>
          ...
          <View style={styles.modalContent}>
            ...
            >
              ...
              <TextInput
                ...
                placeholder={
                  actionType === "valid"
                    ? "Tulis nama obat, jumlah, dan dosis pemakaian..."
                    : "Tulis alasan penolakan resep secara jelas..."
                }
            ...
            <View style={styles.modalFooter}>
              ...
              <TouchableOpacity
                style={[
                  ...
                  {
                    backgroundColor:
                      actionType === "valid" ? THEME.primary : THEME.danger,
                  },
                ]}
