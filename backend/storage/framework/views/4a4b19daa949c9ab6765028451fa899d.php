<?php $__env->startSection('page_title', 'Laporan Bisnis Global'); ?>
...
<div class="space-y-10">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div class="bg-gradient-to-br from-blue-700 to-indigo-800 p-10 rounded-[3rem] text-white shadow-2xl shadow-blue-200">
            ...
            <h3 class="text-5xl font-black mb-8">Rp <?php echo e(number_format($totalRevenue, 0, ',', '.')); ?></h3>
        ...
        <div class="bg-white p-10 rounded-[3rem] border border-slate-100 shadow-sm flex flex-col justify-between">
            <div>
                ...
                <h3 class="text-4xl font-black text-slate-800"><?php echo e($totalOrders); ?> <span class="text-sm font-bold text-slate-400">Order</span></h3>
            </div>
        ...
        <div class="bg-white p-10 rounded-[3rem] border border-slate-100 shadow-sm flex flex-col justify-between">
            <div>
                ...
                <h3 class="text-4xl font-black text-slate-800">
                    Rp <?php echo e($totalOrders > 0 ? number_format($totalRevenue / $totalOrders, 0, ',', '.') : '0'); ?>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
        ...
        <div class="bg-white rounded-[3rem] border border-slate-100 shadow-sm overflow-hidden">
            ...
            <div class="p-10 space-y-8">
                <?php $__currentLoopData = $monthlyRevenue; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="space-y-3">
                    <div class="flex justify-between items-end">
                        <p class="font-bold text-slate-700 text-sm"><?php echo e($item->month); ?></p>
                        <p class="font-black text-blue-700 text-sm">Rp <?php echo e(number_format($item->total, 0, ',', '.')); ?></p>
                    </div>
                    <div class="w-full bg-slate-50 h-3 rounded-full overflow-hidden">
                        <?php $percent = $totalRevenue > 0 ? ($item->total / $totalRevenue) * 500 : 0; ?>
                        <div class="bg-blue-600 h-full rounded-full transition-all duration-1000" style="width: <?php echo e(min(100, $percent)); ?>%"></div>
                    </div>
                </div>
            ...
            <div class="p-6">
                <div class="grid grid-cols-2 gap-6">
                    ...
                    <div class="p-6 rounded-[2rem] bg-slate-50 border border-slate-100 hover:border-blue-200 transition-all group">
                        ...
                        <p class="font-black text-slate-800 text-lg"><?php echo e($cat->count); ?></p>
                        <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest"><?php echo e($cat->category); ?></p>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\MyBook Hype AMD\apotek-permata\backend\resources\views/admin/reports.blade.php ENDPATH**/ ?>